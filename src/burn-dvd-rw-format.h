...
typedef struct BraseroDvdRwFormatPrivate BraseroDvdRwFormatPrivate;

typedef struct {
	BraseroProcess parent;
	BraseroDvdRwFormatPrivate *priv;
} BraseroDvdRwFormat;

typedef struct {
	BraseroProcessClass parent_class;
} BraseroDvdRwFormatClass;

GType brasero_dvd_rw_format_get_type ();

BraseroDvdRwFormat *brasero_dvd_rw_format_new ();
